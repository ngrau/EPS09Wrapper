...
C *********************************************************
     ...
     &                   ruv, rdv, ru, rd, rs, rc, rb, rg)
      ...
      Character (Len=100) filenimi
      Character (Len=51) dir
...
C     Read the table
      ...
      If (order .EQ. 1) then
        ...
        If (A < 10) Then
        Write(filenimi,
     &   '(A2, "EPS09LOR_", I1)') dir, A
        Else If (A < 100) Then
        Write(filenimi,
     &   '(A2, "EPS09LOR_", I2)') dir, A
        Else If (A < 1000) Then
        Write(filenimi,
     &   '(A2, "EPS09LOR_", I3)') dir, A
        End If
      ...
      Else
        ...
        If (A < 10) Then
        Write(filenimi,
     &   '(A51, "/EPS09NLOR_", I1)') dir, A
        Else If (A < 100) Then
        Write(filenimi,
     &   '(A51, "/EPS09NLOR_", I2)') dir, A
        Else If (A < 1000) Then
        Write(filenimi,
     &   '(A51, "/EPS09NLOR_", I3)') dir, A
        End If
